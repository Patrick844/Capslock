...
- **No fallback heuristic for clustering.** If the LLM mis-clusters (misses a 4th outlet of the GPT-5 story), there's no second-pass title-similarity check. Jaccard on tokenised titles would be a cheap safety net.
